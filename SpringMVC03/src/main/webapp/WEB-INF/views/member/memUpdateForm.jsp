...
<head>
  ...
  <script>
  	...
  	function goUpdate() {
  		...
  		if(memAge == 0 || memAge == null || memAge == "") {
  			alert("나이를 입력하세요.");
  			return false;
  		}
...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading">회원 정보 수정 양식</div>
   	...
   	<form name="frm" action="${contextPath}/memUpdate.do" method="post">
   		...
   		<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">	
   			...
   			<tr>
   				...
   				<td colspan="2"><input id="memEmail" name="memEmail" class="form-control" type="text" maxlength="20" placeholder="이메일을 입력하세요" 
   					value="${mvo.memEmail}"/></td>
   			</tr>
   			<tr>
